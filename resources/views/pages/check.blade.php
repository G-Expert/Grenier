                     ...
                     <form action="grenier_check#transpo" method="post">
                       @csrf
                        <div class="row">
                         ...
                         <div class="col-lg-4">
                          <select class="selectpicker departSelect" name="departSelect" data-width="100%">
                         ...
                         <div class="col-lg-4">
                          <select class="selectpicker arriveSelect" name="arriveSelect" data-width="100%">
                         ...
                         <div class="col-lg-4">
                          <select class="selectpicker uniteSelect" name="uniteSelect" data-width="100%">
