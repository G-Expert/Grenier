                ...
                <ul class="navbar-nav flex-column" id="sideNavbar">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="#!" data-toggle="collapse" data-target="#navDashboard" aria-expanded="false" aria-controls="navDashboard">
                            <i class="nav-icon fe fe-home mr-2"></i>Commandes
                        </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="#!" data-toggle="collapse" data-target="#navCourses" aria-expanded="false" aria-controls="navCourses">
                            <i class="nav-icon fe fe-book mr-2"></i>Clients
                        </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="#!" data-toggle="collapse" data-target="#navProfile" aria-expanded="false" aria-controls="navProfile">
                            <i class="nav-icon fe fe-user mr-2"></i>Gestion des courses
                        </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="#!" data-toggle="collapse" data-target="#navtransport" aria-expanded="false" aria-controls="navProfile">
                            <i class="nav-icon fe fe-user mr-2"></i>Transporteurs
                        </a>
                        <div id="navtransport" class="collapse " data-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link" href="transp_lock">Comptes bloqués</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="zone">
                            <i class="nav-icon fe fe-user mr-2"></i>Gestion des zones
                        </a>
                    </li>
